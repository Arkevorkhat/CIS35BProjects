...
public class OptionSet implements Serializable {
	 ...
	 *                                        object
	 */
	protected void SetOptionByName(String name, float Cost) throws NullPointerException {
		checkArray();
		for (Option op : this.options) {
	 ...
	 */
	protected void setOptionByCost(float Cost, float Set) throws NullPointerException {
		checkArray();
		for (Option op : this.options) {
			if (op.getCost() == Cost) {
				op.setCost(Set);
	 ...
	 *                       object
	 */
	protected void checkArray() throws NullPointerException {
